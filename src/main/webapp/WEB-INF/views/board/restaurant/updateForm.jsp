...
<body>
	...
	<input type="hidden" id="id" value="${restaurant.id }" />
		<div class="form-group ">
			<label for="title">업체명</label> <input type="text" value="${restaurant.title }"
		...
		<div class="form-group ">
			...
			<input type="text"  value="${restaurant.region }" class="w-25 text-center"  name="region"  id="region" placeholder="도시">
		</div>
		
		<br />
		<div class="form-group ">
			<label for="address">Address :&nbsp;</label>
			<input type="text" value="${restaurant.address }" class="w-75 "  id="address" placeholder="주소를 입력해 주세요">
		</div>
		<br />
		<div class="form-group ">
